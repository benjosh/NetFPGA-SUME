...
proc init_gui { IPINST } {
	...
	set C_DPT_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_DPT_WIDTH]
	set C_SPT_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_SPT_WIDTH]
	set C_LEN_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_LEN_WIDTH]
