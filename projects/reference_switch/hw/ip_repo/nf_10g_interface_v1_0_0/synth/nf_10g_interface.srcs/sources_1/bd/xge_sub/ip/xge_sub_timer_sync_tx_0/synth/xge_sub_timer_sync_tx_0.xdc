...
set_max_delay -from [get_cells {*source_nanosec_sample_reg[*]}] -to [get_cells {*source_nanosec_8_0_wrap_value_reg[*]}] 6.4 -datapath_only
set_max_delay -from [get_cells {*timer_sec_sample_reg[*]}]      -to [get_cells {*resync_sec_reg[*]}] 6.4 -datapath_only
set_max_delay -from [get_cells {*source_nanosec_sample_reg[*]}] -to [get_cells {*resync_nanosec_reg[*]}] 6.4 -datapath_only
