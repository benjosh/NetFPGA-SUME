...
#Noa = AI: check why the below causes errors
#set_property -dict [list CONFIG.TDATA_NUM_BYTES [get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins pcie_2_axilite_0/s_axis_cq]] CONFIG.TUSER_WIDTH [get_property CONFIG.TUSER_WIDTH [get_bd_intf_pins pcie_2_axilite_0/s_axis_cq]] CONFIG.HAS_TKEEP [get_property CONFIG.HAS_TKEEP [get_bd_intf_pins pcie_2_axilite_0/s_axis_cq]] CONFIG.HAS_TLAST [get_property CONFIG.HAS_TLAST [get_bd_intf_pins pcie_2_axilite_0/s_axis_cq]]] [get_bd_intf_ports /s_axis_cq]

set_property -dict [list CONFIG.TDATA_NUM_BYTES [get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_ports /s_axis_cq]] CONFIG.TUSER_WIDTH [get_property CONFIG.TUSER_WIDTH [get_bd_intf_ports /s_axis_cq]] CONFIG.HAS_TKEEP [get_property CONFIG.HAS_TKEEP [get_bd_intf_ports /s_axis_cq]] CONFIG.HAS_TLAST [get_property CONFIG.HAS_TLAST [get_bd_intf_ports /s_axis_cq]]] [get_bd_intf_ports /s_axis_cq]


set m_axis_cc [create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_cc]
...
#configure 8 Master interfaces
 ...
 # set_property -dict [ list CONFIG.PF0_DEVICE_ID {0007} CONFIG.PL_LINK_CAP_MAX_LINK_SPEED {8.0_GT/s} CONFIG.PL_LINK_CAP_MAX_LINK_WIDTH {X8} CONFIG.cfg_ctl_if {false} CONFIG.cfg_ext_if {false} CONFIG.cfg_fc_if {false} CONFIG.cfg_mgmt_if {false} CONFIG.cfg_status_if {false} CONFIG.cfg_tx_msg_if {false} CONFIG.en_ext_clk {false} CONFIG.en_ext_gt_common {false} CONFIG.mode_selection {Advanced} CONFIG.per_func_status_if {false} CONFIG.pf0_bar0_size {8} CONFIG.pf0_bar1_enabled {true} CONFIG.pf0_bar1_size {4} CONFIG.rcv_msg_if {false} CONFIG.shared_logic_in_core {true} CONFIG.tx_fc_if {false} CONFIG.xlnx_ref_board {VC709}  ] $pcie3_7x_0
 ...
 set pcie_2_axilite_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:pcie_2_axilite:1.0 pcie_2_axilite_0 ]
  ...
  connect_bd_intf_net [get_bd_intf_pins pcie_2_axilite_0/s_axis_cq] [get_bd_intf_ports /s_axis_cq]
  connect_bd_intf_net [get_bd_intf_pins pcie_2_axilite_0/m_axis_cc] [get_bd_intf_ports /m_axis_cc]
...
#connect_bd_net -net pcie3_7x_0_user_lnk_up [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins pcie3_7x_0/user_lnk_up] [get_bd_pins pcie_2_axilite_0/axi_aresetn]
  connect_bd_net -net sys_reset_net [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins /sys_reset] [get_bd_pins pcie_2_axilite_0/axi_aresetn]
